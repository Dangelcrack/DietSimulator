...
public class DietaController extends Controller implements Initializable {
    ...
    /**
     * Saves a new Dieta both to the database and the observable list.
     * @param newDieta The new Dieta to be added.
     */
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        columnDescription.prefWidthProperty().bind(
                tableView.widthProperty()
                        .subtract(columnName.getPrefWidth())
                        .subtract(dietType.getPrefWidth())
                        .subtract(2)
        );
    ...
    /**
     * Handles the event when the user wants to add a Dieta.
     *
    ...
    /**
     * Handles the event when the user wants to delete a Dieta.
     *
     * @throws IOException If an I/O error occurs.
     */
    @FXML
    ...
    /**
     * Handles the event when the user wants to edit a Dieta.
     *
     * @throws IOException If an I/O error occurs.
     */
    @FXML
