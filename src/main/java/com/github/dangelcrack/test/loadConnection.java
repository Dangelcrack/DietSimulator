 ...
 * The ConnectionProperties object is populated by reading the "connectionmysql.xml" file
 * using the XMLManager utility class.
 */
public class loadConnection {
    public static void main(String[] args) {
        ConnectionProperties c = XMLManager.readXML(new ConnectionProperties(), "connectionmysql.xml");
